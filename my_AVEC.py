...
# from my_model import AVECModel, AVECBiModel, AVECBiModelTri, MaskedMSELoss
from my_cla_model2 import AVECBiModelTri, MaskedMSELoss
...
if __name__ == '__main__':
    ...
    model = AVECBiModelTri(D_m_T, D_m_V, D_m_A, D_m, D_g, D_p, D_e, D_h,
                    attr=args.attribute,
                    listener_state=args.active_listener,
                    context_attention=args.attention,
                    dropout_rec=args.rec_dropout,
                    dropout=args.dropout)
#    model = AVECBiModel(D_m_T, D_m_A, D_m, D_g, D_p, D_e, D_h,
#                    attr=args.attribute,
#                    listener_state=args.active_listener,
#                    context_attention=args.attention,
#                    dropout_rec=args.rec_dropout,
