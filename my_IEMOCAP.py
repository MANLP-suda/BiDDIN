...
from my_cla_model2 import MaskedNLLLoss, IEMOCAPUniModelTri, IEMOCAPBiModelTri
# from my_model_for_speech import IEMOCAPUniModelBi
...
def train_or_eval_model(model, loss_function, dataloader, epoch, optimizer=None, train=False):
    ...
    for data in dataloader:
        ...
        log_prob, alpha, alpha_f, alpha_b = model(textf, visuf, acouf, qmask, umask)  # seq_len, batch, n_classes
...
if __name__ == '__main__':
    ...
    D_m = 100  # text 100 audio 100 visual 512
    # D_m = 150
    D_g = 150
    D_p = 150
    D_e = 100
    ...
    #    D_m = 80 #text 100 audio 100 visual 512
    #    D_g = 120
    #    D_p = 120
    #    D_e = 80
    #    D_h = 80

    #    D_a = 80 # concat attention
    ...
    train_loader, valid_loader, test_loader = \
        get_IEMOCAP_loaders('./DialogueRNN_features/DialogueRNN_features/IEMOCAP_features/IEMOCAP_features_raw.pkl',
                            valid=0.1,
                            batch_size=batch_size,
                            num_workers=2)
    ...
    for e in range(n_epochs):
        ...
        if best_fscore == None or best_fscore < test_fscore:
            best_loss, best_label, best_pred, best_mask, best_attn, best_fscore = \
                test_loss, test_label, test_pred, test_mask, attentions, test_fscore
            # torch.save(model.state_dict(), './models/BIDDIN_params.pth')
