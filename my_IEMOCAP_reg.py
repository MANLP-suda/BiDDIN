...
from my_model_for_speech import IEMOCAPBiModelBi_Reg
...
def get_AVEC_loaders(path, dim=0,  batch_size=32, valid=0.1, num_workers=0, pin_memory=False):
    ...
    testset = AVECDataset(path=path, dim=dim)
...
if __name__ == '__main__':
    ...
    model = IEMOCAPBiModelBi_Reg(D_m_T, D_m_A, D_m, D_g, D_p, D_e, D_h,
                    listener_state=args.active_listener,
                    context_attention=args.attention,
                    dropout_rec=args.rec_dropout,
                    dropout=args.dropout)
    ...
    #         get_AVEC_loaders('./DialogueRNN_features/DialogueRNN_features/AVEC_features/AVEC_features_{}.pkl'.format(args.attribute),
    #                             valid=0.0,
    #                             batch_size=batch_size,
    #                             num_workers=2)
    train_loader, valid_loader, test_loader =\
