...
from model import BiModel, Model, MaskedNLLLoss,myRTModel
...
def train_or_eval_model(model, loss_function, dataloader, epoch, optimizer=None, train=False):
    ...
    for data in dataloader:
        ...
        log_prob, alpha, alpha_f, alpha_b = model(torch.cat((textf,visuf,acouf),dim=-1), qmask,umask) # seq_len, batch, n_classes
...
if __name__ == '__main__':
    ...
    # D_m = 200 #text 100 audio 100 visual 512
    D_m = 712 #text 100 audio 100 visual 512
    D_g = 150
    D_p = 150
    D_e = 100
    D_h = 100
    ...
    model = myRTModel(D_m, D_g, D_p, D_e, D_h,
                    n_classes=n_classes,
                    listener_state=args.active_listener,
                    context_attention=args.attention,
                    dropout_rec=args.rec_dropout,
